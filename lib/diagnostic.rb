...
# BDD is driven by user stories. Feature tests are written with a specific user
# story in mind, and then unit tests break that feature down into it's smallest
# component elements, allowing recursive development. Test driven development
# does not consider user stories.
...
RSpec.describe 'Examples API' do
  describe 'Get /examples' do
    it 'lists all examples' do
      ...
      expect(examples_response.first['text']).to eq(examples['text'])
    end
  end
end
#
