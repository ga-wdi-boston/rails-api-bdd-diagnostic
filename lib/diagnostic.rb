...
# Behavior driven development is a way of approaching the sequence of code you
# write. You try to do the first thing you want to add and test it and let the
# errors you get guide you one by one along the way. Testing again down the
# line each step to make sure you are not breaking anything that previously
# worked.
...
RSpec.describe 'routes for examples' do
  it 'routes GET /examples/:id to the examples#show action' do
    expect(get('/examples/8')).to route_to(
      controller: 'examples',
      action: 'show',
      id: '8'
    )
