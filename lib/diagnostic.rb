...
# Behavior Driven Development is a testing process that allows you to run
# small and large scale tests on all parts of your app.
...
RSpec.describe ExamplesController do
  ...
  describe 'POST create' do
    before(:each) do
      post :create, article: example_params, format: :json
  end
