...
# BDD is used to in order to  test for  an apps expected behavior.
# This differs from TDD in that testing for behavior is more benefical for
# with respect to readable feedback and and takeaways.
