...
Behavior Driven Development: (top down)
Starts with User story. Build a feature test, then build unit tests for
each part of the feature (routes, controllers, models, serializers, etc.),
then refactor once its great.

Also starts with a user story. Test Driven Development (bottom up) is the
opposite. Write lots of unit tests and then a integration test at the end.
