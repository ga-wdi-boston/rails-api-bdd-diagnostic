...
# BDD is top down testing, meaning it is about writing a feature which causes
# an error then writing a unit that causes the same error and writing code to pass
# it. Test driven development however is exactly as the name states, and it is
# also bottom up testing. You write tests which drive your code. So you would
# write a test that fails, write code that makes the test pass, then refactor.
# So get it working, then refactor to make it better.
