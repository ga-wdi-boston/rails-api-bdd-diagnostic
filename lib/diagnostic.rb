...
# BDD is a better way to run tests on your project because it is easier to
# read and it is more specific to the errors you recieve with its tests.
# With TDD, you run tests and watch them fail like you would with BDD but,
# there is a higher possibility to get an error because of tests being written
# poorly.
...
# NOTE NOTE NOTE NOTE NOTE ASK about the example response and examples_response
# Question 5
#
