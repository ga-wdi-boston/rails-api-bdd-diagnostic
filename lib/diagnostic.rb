...
# Behaviour Driven Development expands upon Test Driven Development. BDD starts
# with a user story, then a feature test is writen for that story. Only once the
# test is written will you start to code.
